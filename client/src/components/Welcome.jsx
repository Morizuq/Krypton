...
const commonStyles =
  "min-h-[70px] sm:px-0 px-2 sm:min-w-[120px] flex justify-center border-[0.5px] border-gray-400 text-sm font-light text-white items-center";
      ...
      <div className="flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
        <div className="flex flex-1 justify-start items-start flex-col mf:mr-10">
          ...
          <p className="text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
            Explore the crypto verse, buy and sell cryptocurrencies easily on
            Krypton.
          </p>
          {!currentAccount && (
            <button
